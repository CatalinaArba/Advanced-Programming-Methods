...
public class View {
    ...
    private void runExample1() throws ExpressionEvaluationException, ADTException, StatementExecutionException, InterpreterException, IOException, InterruptedException {
    ...
    private void runExample2() throws ExpressionEvaluationException, ADTException, StatementExecutionException, InterpreterException, IOException, InterruptedException {
    ...
    private void runExample3() throws ExpressionEvaluationException, ADTException, StatementExecutionException, InterpreterException, IOException, InterruptedException {
    ...
    private void runExample(IStmt stmt) throws ExpressionEvaluationException, ADTException, StatementExecutionException, InterpreterException, IOException, InterruptedException {
