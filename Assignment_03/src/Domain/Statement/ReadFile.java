...
public class ReadFile implements IStmt{
    ...
    private Exp expression;//path
    private String variableName;//integer
    //Constructor
    ...
    public PrgState execute(PrgState state) throws ADTException, ExpressionEvaluationException, StatementExecutionException {
        ...
        if(symTable.isDefined(variableName.toString())){
            Value value= symTable.lookUp(variableName.toString());
                ...
                if(value.getType().equals(new StringType())){
                    ...
                    if(fileTable.isDefined(stringValue.getVal())){
                        ...
                        try {
                            ...
                            if (line == null)
                                line = "0";
                            symTable.put(variableName.toString(), new IntValue(Integer.parseInt(line)));
                        } catch (IOException e) {
